...
<header className="flex bg-white border-b border-gray-300 py-3 sm:px-6 px-4 min-h-[75px] tracking-wide relative z-50">
      <div className="flex max-w-screen-xl mx-auto w-full">
        <div className="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full">
          ...
          <a href="javascript:void(0)" className="hidden max-sm:block"><img src="https://readymadeui.com/readymadeui-short.svg" alt="logo" className="w-10" />
          </a>
            ...
            <ul
              ...
              <li className="mb-6 hidden max-lg:block">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <button
                    className="px-4 py-2 text-sm rounded-full text-white border-2 border-blue-700 bg-blue-700 hover:bg-[#004bff]">Sign
                    In</button>
                </div>
              </li>
              <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><a href='javascript:void(0)'
                className="text-blue-700 hover:text-blue-700 text-[15px] block font-semibold">Home</a></li>
              <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><a href='javascript:void(0)'
                className="text-slate-900 hover:text-blue-700 text-[15px] block font-semibold">Course</a></li>
              <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><a href='javascript:void(0)'
                className="text-slate-900 hover:text-blue-700 text-[15px] block font-semibold">About us</a></li>
              <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><a href='javascript:void(0)'
                className="text-slate-900 hover:text-blue-700 text-[15px] block font-semibold">Contact</a></li>
            </ul>
          </div>

          <div className="flex items-center gap-x-6 gap-y-4 ml-auto">
            <div
              className="flex bg-gray-50 border border-gray-300 focus-within:bg-transparent focus-within:border-gray-500 rounded-full px-4 py-2.5 overflow-hidden max-w-52 max-xl:hidden">
              <input type='text' placeholder='Search something...' className="w-full text-sm bg-transparent outline-0 pr-2" />
            ...
            <div className="flex items-center sm:space-x-8 space-x-6">
              ...
              <div className="flex flex-col items-center justify-center gap-0.5 cursor-pointer">
                <div className="relative">
                  <Link to="/shoppingcart" onClick={() => scrollTo(0,0)}>
                ...
                <span className="text-[13px] font-semibold text-slate-900">
                  <Link to="/shoppingcart" onClick={() => scrollTo(0,0)}>Cart</Link>
                </span>
              </div>

              <button
                className="max-lg:hidden px-5 py-2.5 text-sm font-medium rounded-full text-white bg-blue-600 hover:bg-blue-700 cursor-pointer">Sign
                In</button>
